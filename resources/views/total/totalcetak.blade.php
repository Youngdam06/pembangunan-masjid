...
<body>
    <div class="form-group">
        ...
        <p align="center"><b>Laporan Saldo Per Jum'at </b></p>


        <h3 class="align-middle text-center text-sm">Saldo Akhir Jumat Lalu Tanggal (@if ($tet_sebelum)
            {{ date('d M Y', strtotime($tet_sebelum->tanggal)) }}
        @endif): @currency($tet_sebelum->uang)</h3>
