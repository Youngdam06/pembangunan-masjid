...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
  ...
  <li class="nav-item">
    <a class="nav-link text-white " href="{{ route('pemasukans.index') }}">
      
        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          <i class="material-icons opacity-10">table_view</i>
        </div>
      
      <span class="nav-link-text ms-1">Laporan Pemasukan</span>
    </a>
  </li>
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
      ...
      <li><a class="dropdown-item" href="{{ route('pemasukans.index') }}">Laporan Pengeluaran</a></li>
    </ul>
  </li>

  <li class="nav-item">
    <a class="nav-link text-white " href="{{ route('pengeluarans.index') }}">
