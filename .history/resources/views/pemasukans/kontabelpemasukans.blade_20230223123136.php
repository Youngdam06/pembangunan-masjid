      ...
      <div class="card my-4">
        ...
        <div class="card-body">
          ...
          {{-- @foreach ($pemasukans as $pemasukan) --}}
            {{-- <div class="mt-3 mb-3 text-center"><h5>Tanggal</h3h5></div>
              <div class="mt-2 mb-2 text-center"></div> --}}
              {{-- <h6>{{$pemasukan->tanggal}}</h6> --}}
            {{-- @endforeach --}}
          
          {{-- tanggal $sudah  => ('sudah bisa ditentukan ['']') --}}
        ...
        <div class="card-body px-0 pb-2">
          <div class="table-responsive p-0">
            <table class="table align-items-center justify-content-center mb-0">
              ...
              @endif
              {{-- bang bang saya minta::duit berharap(bisa 'melakukan itu$ diskon menjadi 100%['enak banget']') --}}
...
{{-- jadi saya disini ingin menjelaskan bagaimana caranya melakukan transaksi bebas tanpa pungut biaya yah teman-teman. --}} 