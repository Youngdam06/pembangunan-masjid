...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <li class="nav-item">
    <a class="nav-link text-white " href="./tambahdata.html">
  ...
  <li class="nav-item">
    <a class="nav-link text-white " href="./tabellaporan.html">
  ...
  <li class="nav-item">
    <a class="nav-link text-white " href="./laporanoperasional.html">
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
              <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                  ...
                  <h6 class="font-weight-bolder mb-0">Tambah<br>&nbsp&nbsp&nbspData</h6>
                ...
                <div class="card z-index-0 fadeIn3 fadeInBottom">
                  ...
                  <div class="card-body">
                    <form role="form" class="text-start">
                        <label class="form-label">1. Laporan Jum'at Tanggal</label>
                      <div class="input-group input-group-outline my-3">
                        <input type="email" class="form-control">
                      </div>
                        <label class="form-label">2. Total Saldo Akhir Jum'at Lalu</label>
                      <div class="input-group input-group-outline mb-3">
                        <input type="password" class="form-control">
                      </div>
                      <label class="form-label">3. Penerimaan Jum'at Lalu</label>
                      <div class="input-group input-group-outline my-3">
                        <input type="email" class="form-control">
                      </div>
                      <label class="form-label">4. Kotak Kaca 1 Pekan</label>
                      <div class="input-group input-group-outline my-3">
                        <input type="email" class="form-control">
                      </div>
                      <label class="form-label">5. Donasi Tetap</label>
                      <div class="input-group input-group-outline my-3">
                        <input type="email" class="form-control">
                      </div>
                      ...
                      <div class="text-center">
                        <button type="button" class="btn bg-gradient-primary w-100 my-4 mb-2">Tambahkan</button>
                      </div>
                    </form>
                  </div>
                </div>
