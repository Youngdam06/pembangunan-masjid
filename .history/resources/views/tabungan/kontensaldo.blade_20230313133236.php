    <div class="row">
        ...
        <div class="card my-4">
            ...
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Laporan Saldo Akhir Jumat Lalu</h6>
            </div>
            </div>
            ...
            <div class="table-responsive p-0">
                ...
                <div class="container">
                    <a class="btn bg-primary btn-dark" href="{{ route('tabungan.createsaldo') }}">Tambah data</a>
                </div>
                </table>
