      ...
      <div class="card-body px-0 pb-2">
        <div class="table-responsive p-0">
          <table class="table align-items-center justify-content-center mb-0">
            ...
            <div class="input-group mb-3">
              <a href="" onclick="this.href='tampil-data-pertanggal'+document.getElementById('tglawal').value +
              '/' + document.getElementById('tglakhir').value" target="_blank" class="btn btn-primary col-md-12">Cetak laporan tanggal</a>
              <i class="fas fa-print"></i>
            </div>
    
            <h6 class="align-middle text-center text-sm">Tanggal {{ $tanggals->tanggal }}</h6>
