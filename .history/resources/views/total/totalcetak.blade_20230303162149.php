    ...
    <body>
        <div class="form-group">
            ...
            <table class="static" align="center" rules="all" border="1px" style="width : 95%;" id="example">
                <h6 class="align-middle text-center text-sm">Saldo Akhir Jumat Lalu: @currency ($tabung->uang)  </h6>
            </table>
            <div class="row">
                <div class="col-12">
                  <div class="card my-4">
      ...
      <div class="card my-4">
        ...
        <div class="card-body px-0 pb-2">
          <div class="table-responsive p-0">
            ...
            <div class="row">
            <button class="btn btn-secondary align-middle text-center text-sm"" onclick="window.print()">Print</button>
          </div>
          </div>
        </div>
      </div>
