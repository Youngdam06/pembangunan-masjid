          ...
          <table class="table align-items-center justify-content-center mb-0">
            ...
            <div class="card-body">
              <div class="input-group mb-3">
                <label for="label">Cari tanggal Pemasukan</label>
            ...
            <div class="input-group mb-3">
              <a href="#" onclick="this.href='/tampil-data-pertanggal-pemasukan/'+document.getElementById('tglmasuk').value + '/tampil-data-pertanggal-pengeluaran/'+document.getElementById('tglkeluar').value" target="_blank" class="btn btn-primary col-md-12"><i class="fas fa-print"></i>      Tampilkan Laporan Data</a></div>
