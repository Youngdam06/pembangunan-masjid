...
<head>
    ...
    <title>Cetak Data Pertanggal | Pengeluaran</title>
</head>
<body>
    <div class="form-group">
        <p align="center"><b>Laporan Saldo Perminggu (Pengeluaran)</b></p>
        ...
        <h3>Jumlah total pemasukan dikurangi pengeluaran :  @currency ( $total->nominal)</h3>
