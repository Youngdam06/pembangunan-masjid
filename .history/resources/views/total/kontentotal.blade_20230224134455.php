          ...
          <table class="table align-items-center justify-content-center mb-0">
            ...
            <div class="card-body">
              <div class="input-group mb-3">
                <label for="label">Tanggal Dari</label>
            ...
            <div class="card-body">
              <div class="input-group mb-3">
                ...
                <input type="date" name="tglsampai" id="tglakhir" class="form-control">
              </div>
            </div>

            <div class="input-group mb-3">
              <a href="#" onclick="this.href='/tampil-data-pertanggal/'+document.getElementById('tgldari').value +
              '/' + document.getElementById('tglsampai').value" target="_blank" class="btn btn-primary col-md-12"><i class="fas fa-print"></i>      Tampilkan Laporan Data</a></div>
