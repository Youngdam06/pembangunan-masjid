    ...
    <body>
        <div class="form-group">
            ...
            <h3 class="align-middle text-center text-sm">Saldo Akhir Tanggal {{ date('d M Y', strtotime($tot->tanggal)) }} :  @currency ($tabung->sum('uang') + $tot->sum('saldo') - $tat->sum('nominal'))  </h3>
