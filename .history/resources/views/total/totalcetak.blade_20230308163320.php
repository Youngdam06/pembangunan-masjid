    ...
    <body>
        <div class="form-group">
            <img src="/assets/img/icon3.jpg" class="navbar-brand-img h-100" width="100px" alt="main_logo">
            <p align="center"><b>Laporan Saldo Per Jum'at Tanggal :  {{ date('d M Y', strtotime($tanggal->tanggal)) }} </b></p>
            ...
            <h3 class="align-middle text-center text-sm">Saldo Akhir Tanggal {{ date('d M Y', strtotime($tanggal->tanggal)) }} : @currency($hasil_perhitungan) </h3>
