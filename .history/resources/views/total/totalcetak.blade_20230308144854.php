    ...
    <body>
        <div class="form-group">
            <p align="center"><b>Laporan Saldo Per Jum'at Tanggal :  {{ date('d M Y', strtotime($tanggal)) }} </b></p>
            ...
            <h3 class="align-middle text-center text-sm">Saldo Akhir Tanggal @foreach ($tot as $total){{ date('d M Y', strtotime($total->tanggal)) }}@endforeach :  @currency ($tabung->sum('uang') + $tot->sum('saldo') - $tat->sum('nominal'))  </h3>
