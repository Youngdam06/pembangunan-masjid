    ...
    <body>
        <div class="form-group">
            ...
            <table class="static" align="center" rules="all" border="1px" style="width : 95%;" id="example">
                <h3 class="align-middle text-center text-sm">Saldo Akhir Jumat Lalu {{ $tanggal1->tanggal }}: @currency ($tabung->uang)  </h3>
            ...
            <table class="static" align="center" rules="all" border="1px" style="width : 95%;" id="example">
              ...
              <h3 class="align-middle text-center text-sm">Saldo Akhir Tanggal {{ date('d M Y', strtotime($tanggal1->tanggal)) }} : @currency($tet->uang) </h3>
            </table>
