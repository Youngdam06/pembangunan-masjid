...
Route::get('saldos', [TabunganController::class, 'index']);
Route::get('saldosedit', [TabunganController::class, 'index']);
Route::post('saldosupdate', [TabunganController::class, 'update']);
