...
Route::get('/tampil-data-pertanggal-pemasukan/{tgl}', [TotalController::class, 'tampilPertanggal'])->name('tampil-data-pertanggal');
Route::get('/tampil-data-pertanggal-pengeluaran/{tgl}', [TotulController::class, 'tampilPertanggal2'])->name('tampil-data-pertanggal');
