...
Route::get('/tampil-data-pertanggal-pemasukan/{tgl}', [TotalController::class, 'tampilPertanggal'])->name('tampil-data-pertanggal-pemasukan');
Route::get('/tampil-data-pertanggal-pengeluaran/{tgl2}', [TotulController::class, 'tampilPertanggal2'])->name('tampil-data-pertanggal-pengeluaran');
