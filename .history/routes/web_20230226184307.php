...
Route::get('/tampil-data-pertanggal-pemasukan/{tglkeluar}', [TotalController::class, 'tampilPertanggal2']);
// Route::get('/tampil-data-pertanggal-pengeluaran/{tglkeluar}', [TotulController::class, 'tampilPertanggal2']);
