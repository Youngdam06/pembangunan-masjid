...
Route::get('/tampil-data-pertanggal/{tgl}', [TotalController::class, 'tampilPertanggal'])->name('tampil-data-pertanggal');
Route::get('/tampil-data-pertanggal/{tgl}', [TotulController::class, 'tampilPertanggal2'])->name('tampil-data-pertanggal2');
