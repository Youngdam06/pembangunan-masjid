...
Route::get('/tampil-data-pertanggal-pemasukan/{tgl}/{tgl2}', [TotalController::class, 'tampilPertanggal']);
Route::get('/tampil-data-pertanggal-pengeluaran/{tgl}', [TotulController::class, 'tampilPertanggal2']);
